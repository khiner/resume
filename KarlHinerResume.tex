...
\section{Projects}
    ...
    \resumeProjectHeading
      {\href{https://github.com/khiner/ProcessingRayTracer}{\textbf{Ray Tracer}} $|$ Java/Processing}{2024}

      \resumeSectionBody{
        Ray tracing, implicit surface generation, and mesh manipulation projects, written in the Processing (Java) language.
      }
    \resumeProjectHeading
      {\href{https://karlhiner.com/drum_classification}{\textbf{Drum Classification}} $|$ Python/PyTorch}{Dec 2023}
