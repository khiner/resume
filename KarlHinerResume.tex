    ...
    \resumeSubheading
      ...
      {Senior Software Engineer - Applied Intelligence Services Team}{Oct 2016 \textbf{--} Dec 2017}
        \resumeItemListStart
          ...
          \resumeItem{Prototyped novel timeseries algorithms and data visualizations using Python, Jupyter, D3.js, and Three.js, including a T-SNE-based clustering visualization for host clustering and outlier detection that was demoed by our product manager in a FutureStack presentation.}
        \resumeItemListEnd
        \vspace{-15pt}
    \resumeSubheading
      {}{}
