...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeItem{
        \textbf{Languages:}{ C++, Python, TypeScript/JavaScript, Java, GLSL, Ruby, Julia, Faust, SQL} \\ \vspace{3pt}
        \textbf{Technologies:}{ Git, React, ImGui, Linux, Postgres, JAX, PyTorch, Vulkan/OpenGL, GLM, Node, Docker} \\ \vspace{3pt}
